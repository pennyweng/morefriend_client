package com.jookershop.linefriend.online;
...
public class OnlineFriendAdapter extends ArrayAdapter<FriendItem> {
...
//	    public String [] colors ={"#A3A948"};
	    ...
	    public OnlineFriendAdapter(Context context, ArrayList<FriendItem> interestItems, String mainColor, DisplayImageOptions options, String enableColor) {
			...
			if (Constants.IS_SUPER) {
				...
				delTv.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						Log.d(Constants.TAG, "del account url " + url);
