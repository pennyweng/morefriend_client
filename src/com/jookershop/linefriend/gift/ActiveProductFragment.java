 ...
 */
public class ActiveProductFragment extends Fragment {
	/**
	 ...
	 */
	public static ActiveProductFragment newInstance() {
		ActiveProductFragment fragment = new ActiveProductFragment();
		return fragment;
	}

	public ActiveProductFragment() {
...
//		.showImageOnLoading(R.drawable.emptyhead)
	...
	public void loadTitleCount() {
		...
		String url = Constants.BASE_URL + "gift/se/next_time?uid=" + uid;
	...
	public void loadItmes(final boolean first) {
		String uid = URLEncoder.encode(AccountUtil.getUid(this.getActivity()));
		String url = Constants.BASE_URL + "gift/se/nlist?uid=" + uid;
