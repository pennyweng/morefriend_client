 ...
 */
public class ActiveGiftFragment extends Fragment {
	/**
	 ...
	 */
	public static ActiveGiftFragment newInstance() {
		ActiveGiftFragment fragment = new ActiveGiftFragment();
		return fragment;
	}

	public ActiveGiftFragment() {
