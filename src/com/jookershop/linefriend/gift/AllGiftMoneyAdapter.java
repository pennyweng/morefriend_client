...
public class AllGiftMoneyAdapter extends ArrayAdapter<GiftItem> {
	private Context mContext;
	private DisplayImageOptions options;
	private SharedPreferences sp;

	public AllGiftMoneyAdapter(Context context, ArrayList<GiftItem> interestItems,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (rowView == null) {
			rowView = LayoutInflater.from(getContext()).inflate(
					R.layout.gift_money_item, parent, false);
...
//			viewHolder.gidTv = (TextView) rowView.findViewById(R.id.textView3);
		...
		holder.maxCount.setText("加購價格：" + postItem.getBaseMoney() + "元\n加購資格：參加" + postItem.getMaxCount() + "次\n目前已參加" + postItem.getClickCount() + "次");
