...
public class FriendDiscussAdapter extends ArrayAdapter<PostItem> {
	...
	private FriendDiscussFragment fdf;
	private int categoryType;
	private String categoryId;

	public FriendDiscussAdapter(Context context,
			ArrayList<PostItem> interestItems, String mainColor,
			DisplayImageOptions options, String selectColor,
			FriendDiscussFragment fdf, int CategoryType, String categoryId) {
...
//		delTv.setBackgroundColor(Color.parseColor("#CF0048"));
...
//					Constants.IMAGE_BASE_URL + "post/image?pid=" + postItem.getPid());
			...
			MainActivity.imageLoader.displayImage(Constants.IMAGE_BASE_URL + "post/image?pid=" + postItem.getPid(), 
...
//						+ postItem.getUid(), R.drawable.emptyhead);
		...
		MainActivity.imageLoader.displayImage(Constants.IMAGE_BASE_URL + "account/image?uid="
				+ postItem.getUid(), 
				holder.userImg, ImageHelper.emptyHeadOptions);
...
//		holder.replyCount.setBackgroundColor(Color.parseColor(selectColor));

//		rowView.setBackgroundColor(Color.parseColor(mainColor));
...
//								+ postItem.getUid(), R.drawable.emptyhead);
				...
				MainActivity.imageLoader.displayImage(Constants.IMAGE_BASE_URL + "account/image?uid="
						+ postItem.getUid(), 
						userImg, ImageHelper.emptyHeadOptions);			
