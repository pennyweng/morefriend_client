...
public class HistoryItemAdapter extends ArrayAdapter<HistoryItem> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(postItem.getGtype().equals(GameItem.TYPE_GUESS))
			holder.guess.setText("我的終極密碼：" + postItem.getGuess());
		else if(postItem.getGtype().equals(GameItem.TYPE_AB))
			holder.guess.setText("我的猜AB數字：" + postItem.getGuess());
		else 
			holder.guess.setText(postItem.getGuess());
