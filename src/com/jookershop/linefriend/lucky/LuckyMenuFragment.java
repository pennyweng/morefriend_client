 ...
 */
public class LuckyMenuFragment extends Fragment {
	/**
	 ...
	 */
	public static LuckyMenuFragment newInstance() {
		LuckyMenuFragment fragment = new LuckyMenuFragment();
		return fragment;
	}

	public LuckyMenuFragment() {
...
//		tabs.setTextColor(Color.parseColor("#828181"));
	...
	public class MyPagerAdapter extends FragmentPagerAdapter {
		...
		private final String[] TITLES = { "抽獎項目", "得獎名單" };
		...
		public Fragment getItem(int position) {
			if(position == 0) {
				return ActiveLuckyFragment.newInstance();
		    } else {
				return WinnerLuckyFragment.newInstance();
