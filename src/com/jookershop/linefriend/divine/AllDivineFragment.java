 ...
 */
public class AllDivineFragment extends Fragment {
	/**
	 ...
	 */
	public static AllDivineFragment newInstance() {
		AllDivineFragment fragment = new AllDivineFragment();
		return fragment;
	}

	public AllDivineFragment() {
...
//		.showImageOnLoading(R.drawable.emptyhead)
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_game_all, container,
				false);
...
//		tabs.setTextColor(Color.parseColor("#037367"));
	...
	public class MyPagerAdapter extends FragmentPagerAdapter {
		...
		private final String[] TITLES = { "愛情指引"};
...
//			if(position == 0)
			return ActiveDivineFragment.newInstance();
//			else return WinnerGameFragment.newInstance();
		}
