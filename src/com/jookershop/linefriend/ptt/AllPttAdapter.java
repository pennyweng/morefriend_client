...
public class AllPttAdapter extends ArrayAdapter<PttItem> {
	...
	private AllPttFragment fdf;


	public AllPttAdapter(Context context, ArrayList<PttItem> interestItems,
			DisplayImageOptions options, AllPttFragment fdf ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final PttItem postItem = getItem(position);
