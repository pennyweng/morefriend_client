 ...
 */
public class NewMessageFragment1 extends Fragment {
	/**
	 ...
	 */
	public static NewMessageFragment1 newInstance() {
		NewMessageFragment1 fragment = new NewMessageFragment1();
		return fragment;
	}

	public NewMessageFragment1() {
...
//		.showImageOnLoading(R.drawable.emptyhead)
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.msg_new_console1, container,
				false);
...
//		tabs.setTextColor(Color.parseColor("#828181"));
	...
	public class MyPagerAdapter extends FragmentPagerAdapter {
		...
		private final String[] TITLES = { "訊息中心", "追蹤名單", "黑名單" };
		...
		public Fragment getItem(int position) {
			if(position == 0) {
				return MessageCenterFragment.newInstance(position + 1);
			} else if(position == 1) {
				return TraceFragment.newInstance(position + 1);
			}else {
				return BlackFragment.newInstance(position + 1);
