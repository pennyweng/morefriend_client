...
public class TodayNewFriendAdapter extends ArrayAdapter<FriendItem> {
...
//	    public String [] colors ={"#A3A948"};
	    ...
	    public TodayNewFriendAdapter(Context context, ArrayList<FriendItem> interestItems, String mainColor, DisplayImageOptions options, String enableColor) {
