...
public class HotNewFriendAdapter extends ArrayAdapter<FriendItem> {
...
//	    public String [] colors ={"#A3A948"};
	    ...
	    public HotNewFriendAdapter(Context context, ArrayList<FriendItem> interestItems, String mainColor, DisplayImageOptions options, String enableColor) {
