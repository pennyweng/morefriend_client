...
public class ActiveNewFriendAdapter extends ArrayAdapter<FriendItem> {
...
//	    public String [] colors ={"#A3A948"};
	    ...
	    public ActiveNewFriendAdapter(Context context, ArrayList<FriendItem> interestItems, String mainColor, DisplayImageOptions options, String enableColor) {
